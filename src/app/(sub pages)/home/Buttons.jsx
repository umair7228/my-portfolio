...
const Buttons = ({ triggerAnimation }) => {
  return (
    <>
      {/* Buttons Section */}
      <div
      className={`flex flex-col gap-5 mt-12 sm:mt-16 md:mt-8 lg:mt-12 xl:mt-24 2xl:mt-16 ${triggerAnimation ? 'opacity-100' : 'opacity-0'} transition-opacity duration-700`}>
